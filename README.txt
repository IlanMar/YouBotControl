...
часть написаная на C++ реализует Remote API и была взята с официальногосайта V-Rep. 
Часть на C# написана мной и реализует методы и алгоритмы для обеспечение движения и
